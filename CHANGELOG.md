...
* **sales-stats:** доход без ручных пополнений + новые платные подписки ([a18cb55](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/a18cb55b4f3722f7576832747a990e6b434559c7))
* **sales-stats:** метрика возвратов в сводке ([fcf1ca0](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/fcf1ca081304747521542178f1adeae29e5f3b2b))
* **sales-stats:** метрика здоровья оплат (success-rate + неудачные покупки) ([b69021c](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/b69021c75feca5a18f2df885f9c416732be35d95))
...
* Поддержка кастомных Telegram Premium Emoji в кнопках для Menu Layout (Bot API 9.4+) ([7c8f207](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/7c8f207abb789918bba30537dfe160f412b60760))
...
* **account-merge:** не падать на общем реферере и не терять юзера в панели ([3de2a78](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/3de2a788d96df3093be0f70a88d1e1d785594a62))
...
* **cabinet-mode:** Главное меню кнопка теперь всегда возвращает в bot-меню ([0f5873a](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/0f5873a2a025709fe2dec4f2049fe80e4627ec97))
...
* **cryptobot:** защитить JSON-каст payload от не-JSON balance-строк ([5758f59](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/5758f59445e27e7ffb80a11c78885f206ce733d8))
...
* **devices:** прорейт докупки устройств по остатку подписки, без потолка в 1 месяц ([66ca65c](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/66ca65cb6ca328b6e9af928d520a3f5f45081423))
...
* **guest-payment:** подарок/гость через шлюз с под-методом (rollypay_sbp и др.) ([837e9e6](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/837e9e65a520bfd864ac13a35f7c3d76cb2fe888))
...
* **landing:** суточные тарифы на лендингах показывали цену 0 и не покупались ([b795583](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/b795583c7963e7b6b640638af91067616b389bb2))
...
* **remnawave-api:** не спамить админ-чат транзиентными таймаутами панели ([cd6902c](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/cd6902c6f6040695c4dd69171e9b9f6f3af18acb))
* **remnawave-api:** не сыпать 404 «not found» в админ-чат (понизить до warning) ([ed9d4e1](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/ed9d4e13753233c9bf6cab9a153bca1ab3b36c3b))
* **remnawave-sync:** пересоздавать панель-юзера и по коду A063, не только A018 ([05c7517](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/05c7517a41d258641aa4f32c61dbd17a08abd01b))
...
* remove non-existent Platega method code 10, rename 11 to Карты (RUB) ([033d0da](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/033d0da5e0033a2310431586a291b529e3ccb89a))
...
* **sales-stats:** возвраты — только реальные, не внутренние откаты ([cec8e27](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/cec8e271810e167d695452965576f668f498d97e))
* **sales-stats:** корректный средний чек в продажах ([0645565](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/06455657900676fab9cfa4f0cc43743e4335ab63))
* **sales-stats:** продления больше не считают докупки трафика/устройств ([bc36187](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/bc361874f50f0530b5ea263a84d392040dc07dd4))
* **sales-stats:** считать выручку с подарков, оплаченных через шлюз ([fafb966](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/fafb966b31cf6f95ed42375e5e290da8bb0db893))
...
* **stars:** default rate 1.3 → 1.0 ₽/⭐ to match Telegram cash-out ([1f32fed](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/1f32fed03dfce89f3df33e282d059fb8f2f850dd))
...
* **stats:** учитывать ВСЕ платёжные шлюзы в доходе (Jupiter/Donut/Lava пропадали) ([d30b821](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/d30b821c970ab3127e3df1fc44dc873fdfcdcd07))
...
* **subscriptions:** дедуп без удаления панель-юзеров (защита от A063 404) ([fb1d72f](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/fb1d72f72cfb24e6490c6d6ff2f9559f87ee6ccf))
* **subscriptions:** реанимировать истёкший тариф при повторной покупке вместо дубля ([2831982](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/2831982a320e9970beee47f541790df6c06db794))
* **subscriptions:** чистить дубли через сервис (БД + панель), не DB-only миграцией ([45189b2](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/45189b2bd40a0fb72b03b5df2fa6b06855c84b14))
...
* **tariffs:** update_tariff принимает trial_duration_days ([51a2e11](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/51a2e11c6eb508db0c34293041b74e2aed4dbc83))
...
* **trial:** 0 ГБ на триал-тарифе = безлимит, не подмена конфигом ([1713452](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/17134523dd7d4917fb8de4bd2d4a43e7d7de1d29))
...
* **trial:** кабинет не должен отбраковывать неактивный триал-тариф ([e197857](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/e197857063e0f9051822288a3f900252e2fed9e5))
...
* **yookassa:** идемпотентное создание платежа, без ложного «FK violation» спама ([ca8b9c8](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/ca8b9c84d87f864337d5c746646d0071b9217474))
* исправление парсинга черного списка (поддержка '#' и извлечение username) ([357d94d](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/357d94d1b0d7fc8036b00cbb6b75175c29821751))
* исправление парсинга черного списка (поддержка '#' и извлечение username) ([2f71846](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/2f7184627a0fb598a8c0208905cdecf0e4bb04a7))
* устранить MissingGreenlet в автоплатежах и починить traceback в логах ([db79cc9](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/db79cc9eb0d7dc7a4a1ae9190f7a23c6c9e6e317))
* устранить root cause MissingGreenlet в автоплатежах через refetch по id ([3b03c25](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/3b03c253cc1603fe54fddcbc8bc374ec2c71bdfc))
...
* **readme:** убрать партнёрство с WATA, шлюз оставить ([f3a215b](https://github.com/Witcher1235/remnawave-bedolaga-telegram-bot/commit/f3a215bb9066bae3b8c840d8750f21500eef47b1))
